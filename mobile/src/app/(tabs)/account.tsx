...
export default function AccountScreen() {
  ...
  return <Screen><ScrollView contentContainerStyle={styles.content}>
    ...
    <Card><Text style={styles.title}>Your food preferences</Text><Text style={styles.body}>Allergies: {user?.allergies?.length ? user.allergies.join(', ') : 'None saved'}</Text><Text style={styles.body}>These preferences apply when you make recipes.</Text></Card>
