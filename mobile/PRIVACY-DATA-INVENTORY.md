...
| AI Chef messages | User-requested cooking assistance | Recent message text is sent over HTTPS to Recipe Reborn and its AI processor for the response; Recipe Reborn does not save the conversation | Sending is user initiated; closing the screen clears the on-device conversation |
