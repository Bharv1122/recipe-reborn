...
export default function AccountDeletionPage() {
  return <div className="min-h-screen"><div className="max-w-3xl mx-auto px-4 sm:px-6 py-12"><div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
    ...
    <p className="text-gray-700">This permanently removes your profile, recipes, collections, meal plans, shopping lists, confirmed pantry inventory, and app sessions. If you have an active subscription, cancel it through the service where you purchased it before returning to delete your account. The mobile app does not provide subscription cancellation controls.</p>
    <p className="text-gray-700">For a subscription purchased on the Recipe Reborn website, sign in and open <Link href="/account" className="text-emerald-700 hover:underline">Account → Manage Subscription</Link>. If you cannot find or access that option, contact support before deleting your account so billing does not continue afterward.</p>
